<template>
  <div>
    <div style="display: flex;justify-content: space-between;margin-top: 10px;margin-bottom: 10px">
      <el-button type="primary" icon="el-icon-plus" @click="showAddView">添加工资账套</el-button>
    ...
    <div>
      ...
      <el-dialog
        ...
        <div style="display: flex;justify-content: flex-start;align-items: center">
          ...
          <el-input style="width: 60%;margin-left: 50px" v-model="salary[title]" v-show="activeItemIndex==index"
                    :placeholder="'请输入'+salaryItemName[index]+'...'" v-for="(value,title, index) in salary"
                    :key="index" prefix-icon="el-icon-edit"></el-input>
        </div>
        <span slot="footer" class="dialog-footer">
          <el-button :disabled="activeItemIndex==0" @click="preStep">{{
